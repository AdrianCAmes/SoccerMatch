...
<v-flex>
   <v-toolbar flat color="white">  
     ...
     <v-flex xs12 sm12 md12>
        ...
        <v-btn   @click="Loggin()" slot="activator" color="primary" dark class="mb-2"  v-bind:href="ruta">Login</v-btn>    
      <v-btn   @click="Register()" slot="activator" color="primary" dark class="mb-2"  v-bind:href="ruta">Register</v-btn>
</v-flex>
