...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=localhost;Initial Catalog=SoccerMatch;User ID=sa;Password=sa;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Alquiler>(entity =>
            {
                ...
                entity.HasOne(d => d.CequipoNavigation)
                    ...
                    .HasConstraintName("Alquiler_Grupo");
            });
            ...
            modelBuilder.Entity<Equipo>(entity =>
            {
                ...
                entity.HasOne(d => d.CdistritoNavigation)
                    ...
                    .HasConstraintName("Grupo_Distrito");
            });
            ...
            modelBuilder.Entity<Participante>(entity =>
            {
                ...
                entity.HasOne(d => d.CequipoNavigation)
                    ...
                    .HasForeignKey(d => d.Cequipo)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("Usuario_Grupo_Grupo");
